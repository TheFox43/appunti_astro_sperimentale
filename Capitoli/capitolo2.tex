...
\end{equation*}
Dove a ogni equivalenza si tiene conto che le altre variabili rimangano costanti (nel caso del rapporto tra aperture diverse, si è assunto che il tempo di integrazione fosse il medesimo).
