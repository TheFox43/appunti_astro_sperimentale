...
\begin{exrc}[Terra vista da Marte]
	A bordo	della sonda Mars Reconnaissance Orbiter c'è una camera di nome HIRISE, con diametro $D=0.5\, m$ e lunghezza focale $F=12\, m$ e la cui grandezza dei pixel è $pxl=12\, \mu m$, il cui compito è l'osservazione del suolo marziano.
\end{exrc}
