...
\end{equation}
Da cui deriva la definizione formale di parsec, come la distanza alla quale la stella ha parallasse di un arcosecondo, ne deriva che:
\begin{equation*}
	D(pc) = \frac{1}{\theta(arcsec)} \qquad \text{dove} \quad
	1rad = \frac{180}{\pi} \cdot 3600 = 206265 arcsec
\end{equation*}
